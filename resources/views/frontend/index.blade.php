...
<main class="no-main ps-home--dark">
    ...
    <section class="ps-component--register">
        <div class="container">
            <h3 class="component__title">Get started to GOGOSHOP</h3>
            <p>Join other shoppers in your area, and try GOGOSHOP today.</p><a class="ps-button" href="{{url('login')}}">Register An Account</a>
        </div>
    </section>
</main>
@endsection
