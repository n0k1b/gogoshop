...
<body>
    ...
    <header class="header">
        ...
        <div class="ps-header--center header--mobile">
            <div class="container">
                <div class="header-inner">
                    ...
                    <div class="header-inner__center"><a class="logo open" href="{{ url('/') }}">Go Go<span class="text-black"> Shop.</span></a></div>
        ...
        <section class="ps-header--center header-desktop">
            <div class="container">
                <div class="header-inner">
                    <div class="header-inner__left"><a class="logo" href="{{ url('/') }}">Go Go<span class="text-black"> Shop</span></a>
                        <ul class="menu">
                    ...
                    <div class="header-inner__right">
                      <a class="button-icon icon-md" href="#"><i class="icon-heart"></i><span class="badge bg-warning">2</span></a>
                        <div class="button-icon btn-cart-header"><i class="icon-cart icon-shop5"></i><span class="badge bg-warning" id="cart_itemt_count"></span>
                            <div class="mini-cart">
            ...
            <div class="mobile-search--content">
                ...
                <div class="mobile-search__result">
                    ...
                    <ul class="list-result">
                        <li class="cart-item">
                            <div class="ps-product--mini-cart"><a href="#"><img class="ps-product__thumbnail" src="{{asset('assets')}}/frontend/img/products/01-Fresh/01_18a.jpg" alt="alt" /></a>
                                <div class="ps-product__content"><a class="ps-product__name" href="#"><u>Organic</u> Large Green Bell Pepper</a>
                        ...
                        <li class="cart-item">
                            <div class="ps-product--mini-cart"><a href="#"><img class="ps-product__thumbnail" src="{{asset('assets')}}/frontend/img/products/01-Fresh/01_16a.jpg" alt="alt" /></a>
                                <div class="ps-product__content"><a class="ps-product__name" href="#">Avocado <u>Organic</u> Hass Large</a>
                        ...
                        <li class="cart-item">
                            <div class="ps-product--mini-cart"><a href="#"><img class="ps-product__thumbnail" src="{{asset('assets')}}/frontend/img/products/01-Fresh/01_32a.jpg" alt="alt" /></a>
                                <div class="ps-product__content"><a class="ps-product__name" href="#">Tailgater Ham <u>Organic</u> Sandwich</a>
                        ...
                        <li class="cart-item">
                            <div class="ps-product--mini-cart"><a href="#"><img class="ps-product__thumbnail" src="{{asset('assets')}}/frontend/img/products/01-Fresh/01_6a.jpg" alt="alt" /></a>
                                <div class="ps-product__content"><a class="ps-product__name" href="#">Extreme <u>Organic</u> Light Can</a>
                                    <p class="ps-product__rating">
                                        <select class="rating-stars">
                                            <option value="1">1</option>
                                            <option value="2">2</option>
                        ...
                        <li class="cart-item">
                            <div class="ps-product--mini-cart"><a href="#"><img class="ps-product__thumbnail" src="{{asset('assets')}}/frontend/img/products/01-Fresh/01_22a.jpg" alt="alt" /></a>
                                <div class="ps-product__content"><a class="ps-product__name" href="#">Extreme <u>Organic</u> Light Can</a>
            ...
            <div class="ps-footer--service">
                <div class="row">
                    <div class="col-12 col-lg-4">
                        ...
                        <p class="service__app">Get Go Go Shop App </p>
        ...
        <div class="navigation__content">
            <ul class="menu--mobile">
                ...
                <li class="menu-item-has-children"><a href="#">Shop</a><span class="sub-toggle"><i class="icon-chevron-down"></i></span>
                    <ul class="sub-menu">
                        <li> <a href="#">Shop Default View Grid</a>
                        </li>
                        <li> <a href="#">Shop Default View Listing</a>
                        </li>
                        <li> <a href="#">Shop Default View Products</a>
                        </li>
                        <li> <a href="#">Shop Categories</a>
                        </li>
                        <li> <a href="#">Shop With Banner</a>
                        </li>
                        <li> <a href="#">Shop All Brands</a>
                        </li>
                    </ul>
                </li>
